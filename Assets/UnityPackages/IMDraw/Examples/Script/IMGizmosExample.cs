...
public class IMGizmosExample : MonoBehaviour
{
	...
	[TextArea]
	public string m_3DLabelString = "This is a 3D label";
	...
	void OnDrawGizmos()
	{
		...
		IMGizmos.Label(m_2DLabelPosition.x * (float)camera.pixelWidth, m_2DLabelPosition.y * (float)camera.pixelHeight, m_2DLabelColor, m_2DLabelPivot, m_2DLabelAlignment, m_2DLabelString);
