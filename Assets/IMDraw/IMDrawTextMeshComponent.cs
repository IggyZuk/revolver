...
public class IMDrawTextMeshComponent
{
	...
	public void Draw ()
	{
		...
		m_CameraPosition = cameraTransform.localPosition;
...
public class IMDrawTextMeshComponentInspector : PropertyDrawer
{
	...
	public override void OnGUI (Rect rect, SerializedProperty prop, GUIContent label)
	{
		...
		EditorGUILayout.PropertyField(prop.FindPropertyRelative("m_Font"), LABEL_FONT);
		//EditorGUILayout.PropertyField(prop.FindPropertyRelative("m_Material"), LABEL_FONTMATERIAL);
		GUI.enabled = true;

		EditorGUILayout.PropertyField(prop.FindPropertyRelative("m_FontSize"), LABEL_FONTSIZE);

		EditorGUILayout.PropertyField(prop.FindPropertyRelative("m_MaxTextMeshes"), LABEL_MAXTEXTMESHES);

		EditorGUILayout.PropertyField(prop.FindPropertyRelative("m_DefaultAlignment"), LABEL_DEFAULTALIGNMENT);
		EditorGUILayout.PropertyField(prop.FindPropertyRelative("m_DefaultAnchor"), LABEL_DEFAULTANCHOR);
		...
		FloatProperty(prop, "m_DistanceScale", LABEL_DISTANCESCALE , 0.0001f, float.MaxValue);

		EditorGUILayout.PropertyField(prop.FindPropertyRelative("m_DistanceFade"), LABEL_DISTANCEFADE);

		EditorGUILayout.PropertyField(prop.FindPropertyRelative("m_FontSizeAffectsScale"), LABEL_FONTSIZEAFFECTSSCALE);
	}
	...
	private static void FloatProperty (SerializedProperty prop, string memberName, GUIContent label, float minValue, float maxValue)
	{
		SerializedProperty floatProperty = prop.FindPropertyRelative(memberName);

		EditorGUILayout.PropertyField(floatProperty, label);
	...
	private static void ClampMinMax(ref float valueMin, ref float valueMax, float limitMin, float limitMax)
	{
