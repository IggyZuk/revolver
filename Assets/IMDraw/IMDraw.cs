...
public static class IMDraw
{
	...
	{
		if (IMDrawManager.IsGLDrawDisabled) return;
	...
	{
		if (IMDrawManager.IsMeshDrawDisabled) return;
	...
	{
		if (sphereCollider == null || IMDrawManager.IsGLDrawDisabled) return;
	...
	{
		if (boxCollider == null || IMDrawManager.IsGLDrawDisabled) return;
	...
	{
		if (capsuleCollider == null || IMDrawManager.IsGLDrawDisabled) return;
	...
	{
		if (wheelCollider == null || IMDrawManager.IsGLDrawDisabled) return;
	...
	{
		if (meshCollider == null || IMDrawManager.IsGLDrawDisabled) return;
	...
	{
		if (collider == null || IMDrawManager.IsGLDrawDisabled) return;
	...
	{
		if (mesh == null || IMDrawManager.IsMeshDrawDisabled) return;
	...
	{
		if (IMDrawManager.IsGLDrawDisabled || light == null || light.type != LightType.Spot) return;
	...
	{
		if (camera == null || IMDrawManager.IsGLDrawDisabled) return;
